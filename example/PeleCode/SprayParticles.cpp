...
#ifdef USE_GRIT
/*
    std::cout<<"statearr"<<std::endl;
    std::cout<<"size="<<statearr.size()<<std::endl;
    std::cout<<"NX="<<statearr.jstride<<std::endl;
    std::cout<<"NY="<<statearr.kstride/statearr.jstride<<std::endl;
    std::cout<<"ncomp="<<statearr.ncomp<<std::endl;
    std::cout<<"begin"<<statearr.begin.x<<statearr.begin.y<<std::endl;
    std::cout<<"end"<<statearr.end.x<<statearr.end.y<<std::endl;

    std::cout<<"sourcearr"<<std::endl;
    std::cout<<"size="<<sourcearr.size()<<std::endl;
    std::cout<<"NX="<<sourcearr.jstride<<std::endl;
    std::cout<<"NY="<<sourcearr.kstride/sourcearr.jstride<<std::endl;
    std::cout<<"ncomp="<<sourcearr.ncomp<<std::endl;
    std::cout<<"begin"<<sourcearr.begin.x<<sourcearr.begin.y<<std::endl;
    std::cout<<"end"<<sourcearr.end.x<<sourcearr.end.y<<std::endl;
*/
