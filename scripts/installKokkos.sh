...
KOKKOS_OPTION="-DKokkos_ENABLE_SERIAL=ON -DKokkos_ENABLE_OPENMP=ON -DKokkos_ENABLE_CUDA=ON -DKokkos_ENABLE_CUDA_LAMBDA=ON"
KOKKOS_DIR=/opt/sw/kokkos.${KOKKOS_VERSION}
